        ...
        return $form
            ->schema([
                ...
                ->schema([
                    ...
                    Forms\Components\Textarea::make('address')->rows(3)->required(),
                    Forms\Components\FileUpload::make('thumbnail')->image()->required(),
                    Forms\Components\FileUpload::make('venue_thumbnail')->image()->required(),
                    Forms\Components\FileUpload::make('bg_map')->image()->required(),
                ...
                ->schema([
                    ...
                    Forms\Components\TimePicker::make('time_at')->required(),
                ])
            ]);
    }
